...
class ThorlabsBOA(Instrument, LaserDriver):
    """
    ...
    def measure_voltage(self):
        """
        Pass class to satisfy interface requirements
        """
        print("This Thorlabs BOA does not support bias voltage measurement")
        return None
