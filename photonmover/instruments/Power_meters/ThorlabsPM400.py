...
class ThorlabsPM400(Instrument, PowerMeter):
    ...
    def _initialize_params(self):
        ...
        """
        init_commands = ["*RST",                        # Reset to defaults
    ...
    def set_power_unit(self, unit='W'):
        ...
        if unit.lower() in ['w', 'dbm']:
            self.instr.write("SENSE:POWER:UNIT {:s}".format(unit))  # Set dBm as default return unit
        else: 
            return ValueError("Invalid input given for power meter unit. Must be 'W' or 'DBM' ")
