...
# Basic idea: The GUI is simply a placeholder. Each possible experiment we could want 
# to do is a class implementing the Experiment interface. This frontend only shows the
# list of available experiments nicely.
import getopt, sys
...
# Remove 1st argument from the list of command line arguments because it is just the .py file name
