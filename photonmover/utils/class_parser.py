...
class ClassParser:
    ...
    """
    This class parses all the .py files in a specified folder, and returns a list containing all the class names
    ...
    def class_list(self, folder, recursive=False):
        ...
        """ 
        Parses all the .py files in a specified folder, and returns a list containing all the class names defined in
        those files.
        :param folder: the folder of interest
        :param recursive: if True, it does a recursive search within the folders in the base folder
        """
