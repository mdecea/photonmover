...
CALIBRATION_FILENAME = 'C:/Users/POE/Desktop/Marc/photonmover/calibration_data/current_calibration.pickle'
...
def analyze_powers(tap_power, rec_power, wav, calibrate, rec_splitter_ratio=1):
    ...
    """
    Gets the measured powers from the power meter and  applies calibration if indicated
    :param rec_splitter_ratio: if there is a splitter after the output fiber, indicate here the tap to which the
    ...
    if calibrate:
        ...
        if rec_splitter_ratio == 1:
            ...
            measured_input_power = ( (1 - rec_splitter_ratio) / rec_splitter_ratio ) * \
                                   tap_power / through_cal_factor + 1.0e-15
